...
public class AdminReservationItemData {
    ...
    public AdminReservationItemData() {
    }

    public AdminReservationItemData(Long reservationId, String userEmail, String userFirstName, String userLastName,
                                     String spaceId, String spaceName, String spaceLocation,
